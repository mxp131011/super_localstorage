export declare class SuperLocalStorage {
  ...
  /**
   * @param {string} [groupName= '_MXP_GROUP_']  自定义分组的组名（用于删除本插件创建自定义分组下的所有LocalStorage）
   * @param {string} [secretKey = '_MXP_ENCRYPT_'] 加密的密钥
   */
   ...
   */
  set(key: string, value: unknown, time?: string | Date | number[] | number): void;
   ...
   *
   */
  setEncrypt(key: string, value: unknown, time?: string | Date | number[] | number): void;
